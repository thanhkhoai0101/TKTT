<?php //2f4ff09da85b234cf35b030f5c420ac3
/** @noinspection all */
...
namespace LaravelIdea\Helper {
     ...
     * @method $this orWhereDay(string $column, string $operator, \DateTimeInterface|int|null|string $value = null)
     ...
     * @method $this orWhereMonth(string $column, string $operator, \DateTimeInterface|int|null|string $value = null)
     ...
     * @method $this whereMonth(string $column, string $operator, \DateTimeInterface|int|null|string $value = null, string $boolean = 'and')
     ...
     * @method $this whereDay(string $column, string $operator, \DateTimeInterface|int|null|string $value = null, string $boolean = 'and')
