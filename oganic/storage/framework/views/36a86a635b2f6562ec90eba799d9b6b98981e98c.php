<?php if($paginator->hasPages()): ?>
    <nav role="navigation" aria-label="<?php echo e(__('Pagination Navigation')); ?>" class="flex items-center justify-between" id="page">
...
<?php endif; ?>
<?php /**PATH /code/demo/TKTT/oganic/resources/views/vendor/pagination/tailwind.blade.php ENDPATH**/ ?>